...
const AddAssetModal = ({fetchAssets}) => {
    ...
    const handleAddAsset = async () => {
       if(data.title === '' || data.description === '' || data.categorie === '' || data.model === '' || data.brand === '' || data.serialNumber === '' || data.purchaseDate === '' || data.location === ''){
        ...
        try {
            ...
            toast.success('Asset a éte ajouter a    vec succes')
            fetchAssets()
        } catch (error) {
            console.log(error);
            toast.error('probleme lors de l\'ajout de la Asset')
        }
    }
            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="modal-title fs-5" id="exampleModalLabel">Creation d'un Nouveau Asset</h1>
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button" className="btn btn-success" onClick={handleAddAsset}>Crée l'Asset </button>
                    </div>
                </div>
            </div>
        </div>
